import{_ as e,V as t,W as p,X as n,Y as s,$ as o,Z as i,F as l}from"./framework-03e3eb93.js";const c={},r=n("h2",{id:"平衡二叉树",tabindex:"-1"},[n("a",{class:"header-anchor",href:"#平衡二叉树","aria-hidden":"true"},"#"),s(" 平衡二叉树")],-1),u={href:"https://leetcode.cn/problems/balanced-binary-tree/submissions/",target:"_blank",rel:"noopener noreferrer"},d=i(`<h3 id="分治基本思路" tabindex="-1"><a class="header-anchor" href="#分治基本思路" aria-hidden="true">#</a> 分治基本思路</h3><p>一棵树是否是平衡二叉树, 是<strong>取决与它每个节点对应的子树是否是平衡二叉树</strong>, 只要有一个节点对应的子树不是, 这棵树就不是平衡二叉树</p><p>平衡二叉树 : 每个节点 的左右两个子树的高度差的绝对值不超过 1</p><p>基本思路其实很简单 :</p><ul><li>平衡二叉树<strong>需要判断每个节点的子树是否是平衡二叉树(大问题拆成小问题)</strong>, 所以, 我们需要遍历二叉树</li><li>当前节点的高度, 其实就是当前节点到叶子节点的最大深度</li><li>所以我们获取高度以后, 在后序位置进行判断</li></ul><h3 id="分治代码实现" tabindex="-1"><a class="header-anchor" href="#分治代码实现" aria-hidden="true">#</a> 分治代码实现</h3><div class="language-java line-numbers-mode" data-ext="java"><pre class="language-java"><code><span class="token doc-comment comment">/**
