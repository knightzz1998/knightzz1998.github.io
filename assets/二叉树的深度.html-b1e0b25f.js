import{_ as e,V as t,W as p,X as n,Y as s,$ as o,Z as l,F as i}from"./framework-03e3eb93.js";const c={},u=n("h2",{id:"二叉树的最大深度",tabindex:"-1"},[n("a",{class:"header-anchor",href:"#二叉树的最大深度","aria-hidden":"true"},"#"),s(" 二叉树的最大深度")],-1),d={href:"https://leetcode.cn/problems/maximum-depth-of-binary-tree/",target:"_blank",rel:"noopener noreferrer"},r=l(`<h3 id="回溯基本思路" tabindex="-1"><a class="header-anchor" href="#回溯基本思路" aria-hidden="true">#</a> 回溯基本思路</h3><img src="https://haloos.oss-cn-beijing.aliyuncs.com/typero/image-20230113223126720.png" alt="image-20230113223126720" style="zoom:50%;"><p>二叉树的最大深度就是 : <strong>从根节点到叶子节点的最大的深度</strong></p><ul><li>定义一个全局变量 int res = 0 , 以及局部变量 depth 表示当前层的深度</li><li>当我们访问到根节点的时候(前序位置), 就让 depth++;</li><li>当我们执行到后续位置的时候, 就回溯, 让depth--;</li><li>当遇到叶子节点时, 就比较 res 和 当前层哪个大</li></ul><h3 id="回溯代码实现" tabindex="-1"><a class="header-anchor" href="#回溯代码实现" aria-hidden="true">#</a> 回溯代码实现</h3><div class="language-java line-numbers-mode" data-ext="java"><pre class="language-java"><code><span class="token doc-comment comment">/**
